...
namespace VLUTUTORS.Areas.Admin.Controllers
{
    ...
    public class ManageTutorWalletController : Controller
    {
        ...
        public IActionResult ManageDeposit()
        {
            ...
            List<Naptien> depositPending = _db.Naptiens.Where(m=>m.TrangThai==false).OrderByDescending(m=>m.Id).ToList();
            ...
            List<Naptien> depositDone = _db.Naptiens.Where(m => m.TrangThai == true).OrderByDescending(m => m.Id).ToList();
        ...
        public IActionResult ManageWithdrawal()
        {
            ...
            List<Ruttien> withDrawalPending = _db.Ruttiens.Where(m => m.TrangThai == false).OrderByDescending(m => m.Id).ToList();
            ...
            List<Ruttien> withDrawalDone = _db.Ruttiens.Where(m => m.TrangThai == true).OrderByDescending(m => m.Id).ToList();
        ...
        public IActionResult ConfirmDeposit([Bind(include: "Id,MaNapTien,IdNguoiNap,SoTienNap,TrangThai,ThoiGianNapTien")] Naptien napTien)
        {
            ...
            return RedirectToAction("ManageDeposit", "ManageTutorWallet");
        }
        public IActionResult ConfirmWithdrawal([Bind(include: "Id,MaRutTien,IdNguoiRut,SoTienRut,TrangThai,ThoiGianRutTien")] Ruttien rutTien)
        {
            ...
            TempData["MessageType"] = "success";
            return RedirectToAction("ManageWithdrawal", "ManageTutorWallet");
        }
    }
}
